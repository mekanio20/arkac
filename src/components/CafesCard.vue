<template>
    <router-link :to="`/cafes/detail/${id}`" class="h-[300px] sm:h-[320px] md:h-[350px] px-4 md:px-6 py-4 sm:py-5 md:py-6 border border-arkac-gray-400 rounded-2xl flex flex-col sm:items-start items-center justify-between space-y-0 sm:space-y-8">
